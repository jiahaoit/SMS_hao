...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="StudentModifyServlet">
      <div class="form-group">
        <div class="label">
          <label for="sitename">学号：</label>
        </div>
        <div class="field">
          <input type="text" class="input w50"  size="50" readonly="readonly" placeholder="学号不可修改" name="id" value="<%=stu.getId() %>" >
        </div>
      </div>      
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <input type="text" class="input w50" id="mpass" name="name" size="50" placeholder="请输入姓名" value="<%=stu.getName() %>" />       
        </div>
      </div>      
      <div class="form-group">
        <div class="label">
        ...
        <div class="field">
          <select name="myclass" class="input w50" >
				  <option value="<%=stu.getMyclass() %>"><%=stu.getMyclass() %></option>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="score" size="50" placeholder="请输入成绩" value="<%=stu.getScore() %>" />          
        </div>
      </div>
